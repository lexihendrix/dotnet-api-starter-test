...
namespace dotnet_api_test.Validation
{
    public static class ModelValidation
    {
        public static void ValidateCreateDishDto(CreateDishDto entity)
        {
            ...
            {
                throw new BadRequestExceptionResponse("Model is not valid because following properties are missing: " + string.Join(", ", validationResults.Select( s => s.ErrorMessage).ToArray()));
            }
        }
